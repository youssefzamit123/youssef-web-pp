...
const REWARDS: Reward[] = [
  {
    ...
    cost: 25,
    role: 'kid',
    description: 'Stickers cadeaux DentAI',
  },
  {
    id: 'kid_toothbrush',
    title: 'Brosse a dents fun',
    cost: 55,
    role: 'kid',
    description: 'Brosse enfant edition speciale',
  },
  {
    id: 'kid_surprise_box',
    title: 'Boite surprise',
    cost: 90,
    role: 'kid',
    description: 'Mini cadeau surprise',
  },
  {
    id: 'adult_discount_5',
    title: 'Reduction 5%',
